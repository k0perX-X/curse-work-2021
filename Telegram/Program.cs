    ...
    class Program
    {
        ...
        static async void Bot_OnMessage(object sender, MessageEventArgs e)
        {
            if (e.Message.Text != null)
            {
                ...
                Processing.Get(e.Message.Text, e.Message.MediaGroupId, out bool onLastLetter, out bool cityIsUsed, out string outCity, out int letterNumberFromEnd, out string wikiUrl,
