...
namespace Database
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            {
                Processing.Get(s, "Test", out bool onLastLetter, out bool cityIsUsed, out string outCity, out int letterNumberFromEnd,
                ...
                Console.WriteLine(
                    $"onLastLetter {onLastLetter}, cityIsUsed {cityIsUsed}, outCity {outCity}, letterNumberFromEnd {letterNumberFromEnd}, wikiUrl {wikiUrl}, " +
